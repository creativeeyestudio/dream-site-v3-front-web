    ...
    return <>
      {blocks.map((block, index) => {
        ...
        switch (block.__component) {
          case "page.text":
            return (
              <Text title={block.title} text={block.text} first_block={isFirst} key={index}  />
            )
          case "page.text-intro":
            return (
              <TextIntro title={block.title} text={block.text} first_block={isFirst} key={index} />
            )
          case "page.text-image":
            return (
              <TextImage title={block.title} text={block.text} image={block.image} first_block={isFirst} key={index} />
            )
          case "page.text-double-image":
            return (
              <TextDoubleImage title={block.title} text={block.text} image1={block.image1} image2={block.image2} first_block={isFirst} key={index} />
            )
          case "page.parallax":
            return (
          ...
          case "common.gallery":
            return (
              <Gallery images={block.images} key={index}></Gallery>
            )
